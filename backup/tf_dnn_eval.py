...
flags.DEFINE_string("checkpoint_dir", "", "Base directory for output checkpoints.")
...
def evaluate_from_checkpoint(): #Evaluate model from checkpoint
    ...
    ckpt = tf.train.get_checkpoint_state("/home/Desktop/challenge_1/model.ckpt")
    if True:
        with tf.Session() as sess:
            saver = tf.train.Saver()
            saver.restore(sess=sess, save_path="/home/Desktop/challenge_1/model.ckpt")
