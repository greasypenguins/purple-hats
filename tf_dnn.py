...
def build_estimator(model_dir): #Build an estimator
    ...
    deep_columns = [
        ...
        tf.contrib.layers.embedding_column(weight, dimension=8),
        tf.contrib.layers.embedding_column(admission_type_id, dimension=8),
        tf.contrib.layers.embedding_column(discharge_disposition_id, dimension=8),
        tf.contrib.layers.embedding_column(admission_source_id, dimension=8),
        ...
        tf.contrib.layers.embedding_column(glyburidemetformin, dimension=8),
        tf.contrib.layers.embedding_column(glipizidemetformin, dimension=8),
        tf.contrib.layers.embedding_column(glimepiridepioglitazone, dimension=8),
        tf.contrib.layers.embedding_column(metforminrosiglitazone, dimension=8),
        tf.contrib.layers.embedding_column(metforminpioglitazone, dimension=8),
